    ...
    public function getCurrencySymbol($currencyCode, $locale = 'en_US')
{
    ...
    public function updateprofile() {
        ...
        return response()->json(responder("success", "Oke!", "Profiel succesvol veranderd"));
    }
    ...
    public function updatecompany() {
        ...
        return response()->json(responder("success", "Oke!", "School informatie succesvol veranderd"));
    }
    ...
    public function updatereminders() {
        ...
        return response()->json(responder("success", "Oke!", "Herinneringen succesvol veranderd"));
    }
    ...
    public function updatepassword() {
        ...
        if (hash_compare($user->password, Auth::password(input("current")))) {
            ...
            return response()->json(responder("success", "Oke!", "Wachtwoord succesvol veranderd", "reload()"));
        } else {
    ...
    public function updatesystem() {
        ...
        return response()->json(responder("success", "Oke!", "Systeem instellingen succesvol veranderd", "reload()"));
    }
}