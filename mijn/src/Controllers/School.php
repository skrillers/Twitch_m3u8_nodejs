...
class School {
    ...
    public function update() {
        ...
        return response()->json(responder("success", "Oke!", "School succesvol veranderd", "reload()"));
    }
    ...
    public function sendemail() {
        ...
        if ($send) {
            return response()->json(responder("success", "Oke!", "Email succesvol verstuurd", "reload()"));
        } else {
