...
class Branch {
    ...
    public function update() {
        ...
        return response()->json(responder("success", "Oke!", "Filiaal succesvol veranderd", "reload()"));
    }
    ...
    public function switcher() {
        ...
        return response()->json(responder("success", "Oke!", "Filiaal succesvol omgeruild", "reload()"));
    }
