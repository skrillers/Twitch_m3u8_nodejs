...
class Student{
    ...
    public function create() {
        ...
        if ($signup["status"] == "success") {
            ...
            $notification = 'Nieuwe student account is gemaakt voor <strong>'.input('fname').' '.input('lname').'</strong>.';
          ...
          // send welcome email
            ...
            return response()->json(responder("success", "Student toegevoegd", "Student account succesvol aangemaakt", "reload()"));
        }else{
    ...
    */
    public function addcourse(){
          ...
          return response()->json(responder("success", "Oke!", "Student Succesvol ingeschreven voor de cursus", "reload()"));
    }
    ...
    */
    public function deleteenrollment(){
        ...
        return response()->json(responder("success", "Oke!", "Student inschrijving succesvol verwijderd", "reload()"));
    }
    ...
    private function createinvoice($student, $course, $amountpaid = 0, $paymentmethod = "Other"){
        ...
        $data = array(
          ...
          if ($amountpaid > 0) {
            ...
            $notification = 'Een betaling van <strong>'.money($amountpaid).'</strong> Is ontvangen door <strong>'.$student->fname.' '.$student->lname.'</strong>.';
