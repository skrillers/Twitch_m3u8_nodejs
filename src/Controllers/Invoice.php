...
class Invoice{
   ...
   /**
    ...
    public function addpayment() {
        ...
        $notification = 'Een betaling van <strong>'.money(input('amount')).'</strong> is ontvangen door <strong>'.$student->fname.' '.$student->lname.'</strong>.';
        Landa::notify($notification, $user->id, "payment");

        return response()->json(responder("success", "Oke!", "Betaling succesvol toegevoegd.", "reload()"));
    }
    ...
    public function deletepayment() {
        ...
        Database::table('invoices')->where('id',$invoice->id)->update($data);
        $notification = 'Een betaling van <strong>'.money($payment->amount).'</strong> Is verwijderd van je account.';
    ...
    public function update() {
        ...
        return response()->json(responder("success", "Oke!", "Factuur succesvol veranderd", "reload()"));
    }
