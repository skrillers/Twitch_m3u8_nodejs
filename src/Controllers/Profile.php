...
class Profile{
    ...
    public function update() {
        ...
        return response()->json(responder("success", "Oke!", "Profiel succesvol veranderd", "reload()"));
    }
    ...
    public function sendemail() {
        ...
        if ($send) {
            return response()->json(responder("success", "Oke!", "Email succesvol verzonden", "reload()"));
        } else {
    ...
    public function sendsms() {
        ...
        if (env("DEFAULT_SMS_GATEWAY") == "africastalking") {
            ...
            if ($send) {
                return response()->json(responder("success", "Oke!", "SMS succesvol verzonden", "reload()"));
            } else {
    ...
    public function addnote() {
        ...
        return response()->json(responder("success", "Oke!", "Notities succesvol gepubliceerd", "reload()"));
    }
    ...
    public function deletenote() {
        ...
        return response()->json(responder("success", "Notities verwijderd", "Notities succesvol verwijderd.", "reload()"));
    }
    ...
    public function updatenote() {
        ...
        return response()->json(responder("success", "Oke!", "Notites succesvol veranderd", "reload()"));
    }
    ...
    */
    public function uploadattachment() {
        ...
        if($upload['status'] == 'success'){
            ...
            return response()->json(responder("success", "Oke!", "Gehechtheid succesvol veranderd", "reload()"));
        }else{
